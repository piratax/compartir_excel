...
class ListaInveWidget extends StatefulWidget {
  ...
  ListaInveWidget(this._inventario, this._selectProduct, this._productState,
      {Key key})
      : super(key: key);
  @override
  _ListaInveWidgetState createState() => _ListaInveWidgetState(
      this._inventario, this._selectProduct, this._productState);
}

class _ListaInveWidgetState extends State<ListaInveWidget> {
  _ListaInveWidgetState(List<Map> _inventario, Function(Map p1) selectProduct,
      List<bool> productState);
  @override
            ...
            ? List<DataRow>.generate(
                ...
                (int index) => DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(Text(
                            widget._inventario[index]['cantidad'].toString())),
                        DataCell(Text('Cajas')),
                      ],
                      onSelectChanged: (bool selec) {
                        widget._productState[
                            widget._productState.indexOf(true) == -1
                                ? 0
