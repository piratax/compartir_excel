...
generarExcel(List<Map> inventario) async {
  ...
  excel.updateCell(defaultText,
      CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: 0), 'Cantidad');
  excel.updateCell(defaultText,
      CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: 0), 'Unidad');
  print(inventario);
  // int index =1;
  for (int i = 0; i < inventario.length; i++) {
    ...
    excel.updateCell(defaultText,
        CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: i + 1), 'cajas');
  }
  // inventario.map((e){
